    ...
    <div className="min-h-screen bg-gray-50 flex flex-col p-6">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="w-full max-w-md mx-auto">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-black mb-2">회원가입 해주세요</h2>
            ...
            <div>
             ...
             <div className="relative">
               <input
                 ...
                 className={`w-full px-4 py-4 text-lg border rounded-2xl focus:outline-none focus:ring-2 focus:border-transparent bg-white ${
